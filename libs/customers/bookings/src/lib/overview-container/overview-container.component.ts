...
import { CustomersBookingsRepository } from '../+state/bookings-repository.service';
...
export class OverviewContainerComponent {
  ...
  readonly viewModel$: Observable<ViewModel> = combineLatest({
    bookings: this.bookingsRepository.bookinkgs$,
  ...
  constructor(
    private bookingsRepository: CustomersBookingsRepository,
